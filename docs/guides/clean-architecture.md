# 계층 분리 가이드 (Clean Architecture)

> 출처: 초기 기획에 사용한 에이전트 스킬 문서. 하네스 제거(2026-09-22) 시 팀 참고용으로 docs/guides/로 옮김.
> 이 프로젝트에 실제 적용할 결정은 docs/Architecture.md "계층 규칙" 절이 기준이며, 충돌 시 Architecture.md가 우선한다.
